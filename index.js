...
app.post('/sendmail',async(req,res)=>{
    const data = req.body;
    let html =  `<!DOCTYPE html><html lang="en"><head><meta charset="UTF-8"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta name="viewport" content="width=device-width, initial-scale=1.0"><title>Response</title></head><body><h1>Details filled in contact form : </h1><h4>Name : {userData.name}</h4><h4>Phone No.: {userData.phone}</h4><h4>Gender : {userData.gender}</h4><h4>Email : {userData.email}</h4><h4>Subject : {userData.subject}</h4><h4>Message : {userData.message}</h4></body></html>`
